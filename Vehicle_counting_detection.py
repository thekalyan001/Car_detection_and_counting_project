import cv2
import numpy as np #All the OpenCV array structures are converted to and from Numpy arrays. This also makes it easier to integrate with other libraries
from numpy.core.defchararray import center


# capture frames from a video
capt= cv2.VideoCapture('Vid_vehicle_counting_detection.mp4')
...
while True:
    ...
    kernel = cv2.getStructuringElement(cv2.MORPH_ELLIPSE,(5,5))  #it just givr structure or  shape the algorithm
    ...
    for (i,c) in enumerate(counter_shape):
        ...
        #FONT_HERSHEY_TRIPLEX is a font style
    ...
    #cv2.imshow('Detector',dil_data) #this show 

    #After reading We need to Display frames in a window
